...
class FastText:
    ...
    def __init__(self, method='skipgram'):
        ...
        """
        self.method = method
        self.model = fasttext.FastText._FastText()
    ...
    def train(self, texts):
        ...
        df.to_csv("../Logic/core/word_embedding/train_data.csv", index=False, header=False)
        self.model = fasttext.FastText.train_unsupervised(input="../Logic/core/word_embedding/train_data.csv", model=self.method)
    ...
    def save_model(self, path='../Logic/core/word_embedding/FastText_model.bin'):
        """
    ...
    def load_model(self, path="../Logic/core/word_embedding/FastText_model.bin"):
        """
    ...
    def prepare(self, dataset, mode, save=False, path='../Logic/core/word_embedding/FastText_model.bin'):
        """
...
if __name__ == "__main__":
    ...
    #
    # path = '../Logic/core/word_embedding/train_data.csv'
